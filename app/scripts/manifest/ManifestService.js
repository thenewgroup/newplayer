...
//                            );
        ...
        ROOT.goToNextPage = function (currentPageIDX) {
            var nextPage,
                    ...
                    pageParentComponentIdx;
            ////////////////////////////////////////////////////////////////////////
            // if a array is a string convert the string to an init filled array 
            // stack so we can mangle it, if it's an array just pass it along
            ////////////////////////////////////////////////////////////////////////
            ...
            pageParentComponent = ROOT.getComponent(pageParentComponentIdx);
            ////////////////////////////////////////////////////////////////////////
            // i initialized above with current page position relative to the stack
            ////////////////////////////////////////////////////////////////////////
            for (/* initialized above*/; i < pageParentComponent.components.length; i++) {
                var component = pageParentComponent.components[i];
        ...
        ROOT.goToPreviousPage = function (currentPageIDX) {
            ...
            for (/* initialized above*/; i < pageParentComponent.components.length; i++) {
                ...
                if (component.type === 'npPage') {
                    ...
                    $log.debug('ManifestService::goToNextPage | --> found previousPage, previousPageComponentIdx', previousPage, previousPageComponentIdx);
                    break;
                }
            }
            if (!!previousPageComponentIdx) {
                $log.debug('ManifestService::goToNextPage | sending client to previousPage', previousPage);
        ...
        ROOT.getRelativePagePosition = function (relativePageIDX) {
            var relativePagePosition,
                    i,
                    pageParentComponentIdx;
            ////////////////////////////////////////////////////////////////////////
            // if a array is a string convert the string to an init filled array 
            // stack so we can mangle it, if it's an array just pass it along
            ////////////////////////////////////////////////////////////////////////
            if (typeof relativePageIDX === 'string') {
                var relativePageIDXresult = relativePageIDX.substring(1, relativePageIDX.length - 1);
                ROOT.pageComponentIdx = relativePageIDXresult.split(',');
                var mapResult = ROOT.pageComponentIdx.map(function (x) {
                    return parseInt(x, 10);
                });
                pageParentComponentIdx = mapResult.slice(0);
            } else if (typeof relativePageIDX === 'array') {
                pageParentComponentIdx = relativePageIDX;
            }
            ////////////////////////////////////////////////////////////////////////
            // We need to start looking for the component after current page component
            // pop this child off the array so we can have the parent
...
//            console.log(
//                    '\n::::::::::::::::::::::::::::::::::::::getRelativePagePosition:::::::::::::::::::::::::::::::::::::::::::::::::',
//                    '\n::i::', i,
//                    '\n::relativePageIDX::', relativePageIDX,
//                    '\n::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::'
//                    );
